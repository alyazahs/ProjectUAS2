...
<div class="bg-section">
    <div class="container">
        <h1 class="text-center font-italic bold py-3">Bodycare Products</h1>
        <div class="row">
            <?php
            $sql = "SELECT * FROM produk WHERE id_kategori = 3";
            ...
            if (!$result) {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<a href='add_review.php?productId=" . intval($row["id_produk"]) . "&categoryId=3' class='btn btn-primary'>Add Review</a>";
