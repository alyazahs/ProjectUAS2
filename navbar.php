        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownCategory">
                    <a class="dropdown-item" href="category1.php">MAKE UP</a>
                    <a class="dropdown-item" href="category2.php">SKINCARE</a>
                    <a class="dropdown-item" href="category3.php">BODYCARE</a>
                    <a class="dropdown-item" href="category4.php">HAIRCARE</a>
                </div>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownGRWU">
                    ...
                    <a class="dropdown-item" href="grwu3.php">FASHION</a>
                </div>
            </li>
            <li class="nav-item dropdown">
