...
<div class="bg-section">
    <div class="container">
        <h1 class="text-center font-italic bold" style="color:#582f0e;">Hair Care Products</h1>
        <div class="row">
            <?php
            // Query untuk mengambil produk dengan id_kategori = 2
            ...
            if (!$result) {
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<a href='add_review.php?productId=" . $row["id_produk"] . "&categoryId=2' class='btn btn-primary'>Add Review</a>";
