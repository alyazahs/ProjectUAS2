...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO reviews1 (name, skin_type, usage_duration, review, product_id) VALUES (?, ?, ?, ?, ?)");
...
<div class="container">
    ...
    $result = $conn->query("SELECT * FROM reviews1 WHERE product_id = 1"); // Example product ID
